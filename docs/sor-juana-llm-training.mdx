...
info: |
  ...
  Teaching an LLM to Write Like Sor Juana Inés de la Cruz
drawings:
  persist: false
transition: slide-left
title: Teaching an LLM to Write Like Sor Juana
---

# Como enseñar a un LLM a Escribir como Sor Juana
### Teaching an LLM to Write Like Sor Juana

<div class="stream-starting-soon">
  <div class="main-text animate-pulse-slow">
    <h1 class="text-8xl font-bold mb-8">Stream Comenzará Pronto</h1>
    <h2 class="text-4xl opacity-80">Starting Soon</h2>
  </div>

  <div class="loading-dots mt-12">
    <span class="dot animate-bounce" style="animation-delay: 0s">●</span>
